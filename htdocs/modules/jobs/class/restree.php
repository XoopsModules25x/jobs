...
class ResTree
{
    ...
    function ResTree($table_name, $id_name, $pid_name)
    {
    ...
    function resume_getFirstChild($sel_id, $order = "")
    {
        global $mydirname;
        $arr = array();
    ...
    function resume_getFirstChildId($sel_id)
    {
        global $mydirname;
        $idarray = array();
    ...
    function resume_getAllChildId($sel_id, $order = "", $idarray = array())
    {
        global $mydirname;
    ...
    function resume_getAllParentId($sel_id, $order = "", $idarray = array())
    {
        global $mydirname;
    ...
    function resume_getPathFromId($sel_id, $title, $path = "")
    {
        global $mydirname;
        $result = $this->db->query(
    ...
    function resume_makeMyCatBox($title, $order = "", $preset_id = 0, $none = 0, $sel_name = "", $onchange = "")
    {
        global $mydirname;
        if ($sel_name == "") {
            $sel_name = $this->id;
    ...
    //$preset_id is used to specify a preselected item
    //set $none to 1 to add a option with value 0
    function resume_makeMySelBox($title, $order = "", $preset_id = 0, $none = 0, $sel_name = "", $onchange = "")
    {
        global $mydirname;
        if ($sel_name == "") {
            $sel_name = $this->id;
    ...
    //$preset_id is used to specify a preselected item
    //set $none to 1 to add a option with value 0
    function resume_makeMyAdminSelBox($title, $order = "", $preset_id = 0, $none = 0, $sel_name = "", $onchange = "")
    {
        global $mydirname;
        if ($sel_name == "") {
            $sel_name = $this->id;
    ...
    //$preset_id is used to specify a preselected item
    //set $none to 1 to add a option with value 0
    function resume_makeMySearchSelBox(
    ...
    //$preset_id is used to specify a preselected item
    //set $none to 1 to add a option with value 0
    function resume_makeMyStateSelBox($title, $order = "", $preset_id = 0, $none = 0, $sel_name = "", $onchange = "")
    {
        global $mydirname;
        if ($sel_name == "") {
            $sel_name = $this->id;
    ...
    //$preset_id is used to specify a preselected item
    //set $none to 1 to add a option with value 0
    function resume_makeStateSelBox($title, $order = "", $preset_id = 0, $none = 0, $sel_name = "", $onchange = "")
    {
        global $mydirname;
        if ($sel_name == "") {
            $sel_name = $this->id;
    ...
    //$preset_id is used to specify a preselected item
    //set $none to 1 to add a option with value 0
    function resume_makeMyAdminCompBox($title, $order = "", $preset_id = 0, $none = 0, $sel_name = "", $onchange = "")
    {
        global $mydirname;
        if ($sel_name == "") {
            $sel_name = $this->id;
    ...
    function resume_getNicePathFromId($sel_id, $title, $funcURL, $path = "")
    {
        global $mydirname;
    ...
    // the path is delimetered with "/"
    function resume_getIdPathFromId($sel_id, $path = "")
    {
        $result = $this->db->query(
    ...
    function resume_getAllChild($sel_id = 0, $order = "", $parray = array())
    {
        global $mydirname;
        $sql = "SELECT * FROM " . $this->table . " WHERE " . $this->pid . "=" . $sel_id . "";
    ...
    function resume_getChildTreeArray($sel_id = 0, $order = "", $parray = array(), $r_prefix = "")
    {
        global $mydirname;
    ...
    function resume_makeResSelBox($title, $order = "", $preset_id = 0, $none = 0, $sel_name = "", $onchange = "")
    {
        ...
        while (list($catid, $name, $ordre) = $xoopsDB->fetchRow($result)) {
            ...
            echo"<p><a href=\"category.php?op=NewResCat&amp;cid=$catid\"><img src=\"" . XOOPS_URL
                . "/modules/$mydirname/images/plus.gif\" border=0 width=10 height=10 alt=\"" . _AM_JOBS_ADDSUBCAT
            ...
            foreach ($arr as $option) {
                ...
                $catpath
                    ...
                    $option['prefix'] . "&nbsp;<a href=\"category.php?op=NewResCat&amp;cid=" . $option[$this->id]
                        . "\"><img src=\"" . XOOPS_URL
                        . "/modules/$mydirname/images/plus.gif\" border=0 width=10 height=10 alt=\""
                        . _AM_JOBS_ADDSUBCAT . "\"></a>&nbsp;<a href=\"category.php?op=ModResCat&amp;cid="
                        . $option[$this->id] . "\" title=\"" . _AM_JOBS_MODIFCAT . "\">"
    ...
    function resume_getChildTreeMapArray($sel_id = 0, $order = "", $parray = array(), $r_prefix = "")
    {
    ...
    function resume_getCategoryList()
    {
