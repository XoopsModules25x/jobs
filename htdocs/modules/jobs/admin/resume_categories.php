...
default:
    ...
    echo $indexAdmin->addNavigation('resume_categories.php');
    $indexAdmin->addItemButton(_AM_JOBS_RES_ADDSUBCAT, 'resume_categories.php?op=new_category', 'add');
    ...
    function resumeCategoryDisplayChildren($cid = 0, $category_arr, $prefix = "", $order = "", &$class)
    {
        ...
        foreach (array_keys($category_arr) as $i) {
            ...
            echo "<td align='center' width='10%'>
                        <a href='resume_categories.php?op=edit_category&cid=" . $category_arr[$i]->getVar("cid")
                . "'><img src=" . $pathIcon16 . "/edit.png alt='" . _EDIT . "' title='" . _EDIT . "'></a>
                        <a href='resume_categories.php?op=delete_category&cid="
                . $category_arr[$i]->getVar("cid") . "'><img src=" . $pathIcon16 . "/delete.png alt='" . _DELETE
                . "' title='" . _DELETE . "'></a>
                      </td>
                    </tr>";
    ...
    if ($numrows > 0) {
        ...
        foreach (array_keys($category_arr) as $i) {
            if ($category_arr[$i]->getVar("pid") == 0) {
                ...
                echo "<td align='center' width='10%'>
                            <a href='resume_categories.php?op=edit_category&cid="
                    . $category_arr[$i]->getVar("cid") . "'><img src=" . $pathIcon16 . "/edit.png alt='" . _EDIT
                    . "' title='" . _EDIT . "'></a>
                            <a href='resume_categories.php?op=delete_category&cid="
                    . $category_arr[$i]->getVar("cid") . "'><img src=" . $pathIcon16 . "/delete.png alt='"
...
case "new_category":
    ...
    //$indexAdmin->addItemButton(_AM_JOBS_RES_CATEGORYLIST, 'resume_categories.php?op=list', 'list');
    $indexAdmin->addItemButton(_AM_JOBS_RES_CATEGORYLIST, 'resumes.php', 'list');
    echo $indexAdmin->renderButton('left', '');
